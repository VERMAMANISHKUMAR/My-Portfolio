...
const Portfolio = () => {
  return (
    ...
    <tr>
        ...
        <td><a href='https://github.com/VERMAMANISHKUMAR/Healthcare-Management-System'>HMS GitHub link</a><i class="fa-solid fa-paperclip"></i></td>
        <td><a href='https://myprojecthealthcare.netlify.app/'>Healthcare Management System</a><i class="fa-solid fa-paperclip"></i></td>
    </tr>
    <tr>
        <td>4</td>
        <td>Crypto Tracker App</td>
        <td><a href='https://github.com/VERMAMANISHKUMAR/Crypto-Tracker-App-1'>Crypto Tracker GitHub link</a><i class="fa-solid fa-paperclip"></i></td>
        <td><a href='https://gleaming-hotteok-3ee78d.netlify.app/'>Crypto Tracker Live Project</a><i class="fa-solid fa-paperclip"></i></td>
    </tr>
    <tr>
        <td>5</td>
        <td>Food Appliction</td>
        <td><a href='https://github.com/VERMAMANISHKUMAR/Food-Menu-App'>Food Application GitHub link</a><i class="fa-solid fa-paperclip"></i></td>
        <td><a href='https://vermamanishkumar.github.io/Food-Menu-App/'>Food Application Live Project</a><i class="fa-solid fa-paperclip"></i></td>
    </tr>
    <tr>
    ...
    <td>17</td>
        ...
        <td><a href='https://vermamanishkumar.github.io/Network-Speed-test/'>Music Project-2 GitHub link</a><i class="fa-solid fa-paperclip"></i></td>
        <td><a href='https://vermamanishkumar.github.io/Network-Speed-test/'>Music Project-2 Live Project</a><i class="fa-solid fa-paperclip"></i></td>
    </tr>
    <tr>
    <td>18</td>
